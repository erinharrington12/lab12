...
public class DataEntryFrame extends JFrame
{
    ...
    private void setVisuals(FormData data)
    {
        ...
        // FormData.
        data.setValues(data.getFirstName(), data.getMiddleInitial(), data.getLastName(), data.getDisplayName(),
                data.getSSN(), data.getPhone(), data.getEmail(), data.getAddress(), data.getSignature());
    ...
    public DataEntryFrame()
    {
        ...
        lastPanel.add(importButton);
        lastPanel.add(exportButton);
        this.add(lastPanel);
